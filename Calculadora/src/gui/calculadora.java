...
public class calculadora extends JFrame implements MouseListener, ActionListener, MouseMotionListener {
	int xMouse, yMouse;
	...
	public calculadora() {
		...
		setLocationRelativeTo(null);
		{
			...
			}
			{
				...
				lblresultado.setFont(new Font("Consolas", Font.BOLD, 50));
				lblresultado.setHorizontalAlignment(SwingConstants.RIGHT);
				lblresultado.setBounds(0, 70, 339, 76);
			...
			}
			{
				...
				panel_2.setBounds(0, 0, 351, 21);
				panel.add(panel_2);
				panel_2.setLayout(null);
				{
					lblX = new JLabel("X");
					lblX.setBounds(324, 2, 27, 17);
					panel_2.add(lblX);
					lblX.addMouseListener(this);
					lblX.setFont(new Font("Consolas", Font.BOLD, 20));
	...
	public void mouseDragged(MouseEvent arg0) {
		if (arg0.getSource() == panel_2) {
			do_panel_2_mouseDragged(arg0);
		}
	}
	protected void do_panel_2_mousePressed(MouseEvent arg0) {
		xMouse= arg0.getX();
		yMouse = arg0.getY();
	}
	public void mouseMoved(MouseEvent arg0) {
	}
	protected void do_panel_2_mouseDragged(MouseEvent arg0) {
		int Y = arg0.getYOnScreen();
		int X =arg0.getXOnScreen();
		setLocation(X - xMouse, Y - yMouse);
	}
	protected void do_label_mouseClicked(MouseEvent arg0) {
